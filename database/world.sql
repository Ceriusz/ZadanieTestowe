...
--
-- Host: 127.0.0.1
-- Czas generowania: 17 Paź 2017, 19:24
...
--
-- Struktura tabeli dla tabeli `country_language`
--
...
--
-- Zrzut danych tabeli `country_language`
--
...
--
-- Ograniczenia dla tabeli `country_language`
--
ALTER TABLE `country_language`
  ADD CONSTRAINT `countryLanguage_ibfk_1` FOREIGN KEY (`country_code`) REFERENCES `country` (`Code`);
COMMIT;
